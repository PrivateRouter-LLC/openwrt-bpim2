...
make image  PROFILE="sinovoip_bananapi-m2-berry" \
           PACKAGES="uxc bash kmod-rt2800-usb rt2800-usb-firmware kmod-cfg80211 kmod-mac80211 kmod-rtl8192cu \
                     base-files block-mount fdisk luci-app-minidlna minidlna samba4-server ip6tables-legacy \
                     samba4-libs luci-app-samba4 wireguard-tools luci-app-wireguard iptables-legacy \
                     ...
                     irqbalance ethtool netperf speedtest-netperf iperf3 libdevmapper \
                     curl wget rsync file htop lsof less mc tree usbutils bash diffutils \
                     openssh-sftp-server nano luci-app-ttyd kmod-fs-exfat tcpbridge \
