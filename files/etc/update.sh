...
[ is_connected ] && {
   ...
   opkg install jq bash kmod-mwifiex-pcie kmod-mwifiex-sdio kmod-rtl8723bs git-http kmod-rtlwifi kmod-rtlwifi-btcoexist kmod-rtlwifi-pci kmod-rtlwifi-usb kmod-wil6210 libuwifi kmod-veth
   ...
   opkg install dnsmasq dropbear firewall fstools fuse3-utils fwtool getrandom git glib2 gnupg hostapd-common ip-full ip6tables ipset iw iwinfo jshn adblock luci-app-adblock wwan iwlwifi-firmware-iwl6000g2
   ...
   opkg install luci-app-watchcat luci-app-wireguard luci-base luci-compat luci-i18n-firewall-en kmod-usb2 kmod-usb3 rtl8192eu-firmware
   ...
   opkg install rpcd-mod-rpcsys rpcd-mod-rrdns rsync samba4-libs samba4-server nano sshfs terminfo tor ubi-utils kmod-usb-net-asix-ax88179

   opkg install uboot-envtools ubox ubus ubusd uci uclient-fetch uhttpd uhttpd-mod-ubus urandom-seed urngd usbutils usign vpnc-scripts watchcat wg-installer-client wget-ssl
   ...
   #opkg install /etc/luci-app-tgwireguard_1.0.2-1_all.ipk
